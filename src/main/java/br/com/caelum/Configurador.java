...
import br.com.caelum.interceptor.AutorizadorInterceptor;
...
public class Configurador extends WebMvcConfigurerAdapter {
	...
	public void addInterceptors(InterceptorRegistry registry) {
	    ...
	    registry.addInterceptor(getAutorizadorInterceptor()).addPathPatterns("/produto/form")
	    													.addPathPatterns("/produto/*/form");
	}
	
	@Bean
	public AutorizadorInterceptor getAutorizadorInterceptor() {
